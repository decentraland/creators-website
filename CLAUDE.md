...
- The navbar's **Overview** tab (and the mobile back affordance on the collections list) links to `CREATE_URL` from the env config (`src/config/env/*.json`).
...
Don't add an overview/home route or page here — it was intentionally removed.
